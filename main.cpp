...
int maxHz = 64; // pixels of the image. Few seconds for 256 * 256.
int maxVt = 64; // pixels of the image. Few seconds for 256 * 256.
...
// On crachote.
        ...
        for(int brosseNumero = 1; brosseNumero <= nbBrosse; brosseNumero++) {  // iMax inclus.
            ...
            for(int rgb = 1; rgb <= nbComposantRGB; rgb++) { // Multithread ?
